...
public class LogExtractorTests {
    ...
    void extractFromSingleFile() {
        ...
        assertThat(logs)
            .contains(Log.parse("- - - [17/May/2015:08:05:32 +0000] \"GET /file1 HTTP/1.1\" 200 2 \"-\" \"-\""))
            .contains(Log.parse("- - - [17/May/2015:09:05:32 +0000] \"POST /file2 HTTP/1.1\" 500 3 \"-\" \"-\""))
            .contains(Log.parse("- - - [17/May/2015:10:05:32 +0000] \"HEAD /file1 HTTP/1.1\" 404 4 \"-\" \"-\""))
